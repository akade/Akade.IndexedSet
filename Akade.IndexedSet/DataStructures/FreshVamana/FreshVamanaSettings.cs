...
/// <param name="OutDegreeBound">Parameter R, i.e. the maximum of outgoing connections from each node</param>
/// <param name="DeletionThreshold">The threshold (0-1) after which deletions are performed.</param>
/// <param name="BulkLoadingRandomSeed">Seed used to initialize the initial random neighborhood graph.</param>
